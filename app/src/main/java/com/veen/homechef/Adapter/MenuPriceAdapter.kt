...
class MenuPriceAdapter(private val context: Context, private var listOfCountry: List<Price>) : RecyclerView.Adapter<MenuPriceAdapter.MyViewHolder>() {
    ...
    fun getItem(position: Int): Price {
