...
class SearchPriceAdapter(private val context: Context, private var listOfCountry: List<SearchPrice>) : RecyclerView.Adapter<SearchPriceAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.tvCountryName.text = getItem(position).name + "-" + getItem(position).amount
    }


    fun getItem(position: Int): SearchPrice {
